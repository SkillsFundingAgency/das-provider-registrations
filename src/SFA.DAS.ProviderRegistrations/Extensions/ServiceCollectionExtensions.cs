...
namespace SFA.DAS.ProviderRegistrations.Extensions
{
    public static class ServiceCollectionExtensions
    {
        ...
        {
            var redisConnectionString = configuration.GetSection(ProviderRegistrationsConfigurationKeys.RedisConnectionSettings).Get<ProviderRegistrationsSettings>().RedisConnectionString;
